...
if (empty($_POST['branch'])) {
    redirectWithError("Please enter your branch in the form.");
}
...
if (strlen($_POST['message']) < 5) {
    redirectWithError("Please enter at least 5 characters in the message field.");
}

if (strlen($_POST['number']) < 10) {
    redirectWithError("contact number should have atleast 10 numbers");
}
